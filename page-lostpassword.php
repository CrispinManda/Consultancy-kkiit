                        ...
                        <div class="card-body p-0">
                            <div class="d-flex align-items-center auth-content">
                                <div class="col-lg-6 bg-primary content-left">
                                    <div class="p-3">
                                        <h2 class="mb-2 text-dark">Forgot Password</h2>
                                        <p class=" text-dark">Enter your username or email address and we'll send you a link to reset your password.</p>
                                ...
                                <div class="col-lg-6 content-right">
                                    <img src="https://mdbootstrap.com/img/new/ecommerce/vertical/004.jpg" class="img-fluid image-right" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
